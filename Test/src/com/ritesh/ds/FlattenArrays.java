...
public class FlattenArrays {
	...
	public static void main(String[] args) {
		...
		/*
		 * Call to the method 'merge()' with the array to flatten and a list to store the result This method is static,
		 * then it can be called by the main method without need to create an object.
		 */
		try {
			merge(array, result);
	...
	/**
	 * Recursive method which flatten an array of arbitrarily nested arrays of integers into a flat array of integers.
	 * 
	 * @param array The array to be flattened
	 * @param list The list which will contain the result in a flat array of integers.
	 * @return nothing
	 * @throws InvalidTypeData if the data stored in the Array is not other Array or an Integer value.
	 * @author Sebastian Cabanas
	 * */
	private static void merge(Object[] array, ArrayList<Integer> list) throws InvalidTypeData1 {
		// Move through the length of the array
		for (int i = 0; i < array.length; i++) {
			/*
			 * If the value of this position is another array then the method call itself recursively, sending the array
			 * stored in this position and the list
			 */
			...
			/*
			 * If the value in this position is not an array or an integer, the method throws an exception
			 */
			else {
				throw new InvalidTypeData1("Invalid type of data. It only allows for Integers or Arrays");
			}
		}
	}
}
 ...
 * @author Sebastian Cabanas
 */
class InvalidTypeData1 extends Exception {
	/**
	 * 
	 */
	...
	public InvalidTypeData1(String message) {
		super(message);
	}
